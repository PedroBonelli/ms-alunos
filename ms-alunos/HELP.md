...
* The original package name 'com.github.pedrobonelli.ms-alunos' is invalid and this project uses 'com.github.pedrobonelli.ms_alunos' instead.
...
```
$ docker run --rm -p 8080:8080 ms-alunos:0.0.1-SNAPSHOT
```
